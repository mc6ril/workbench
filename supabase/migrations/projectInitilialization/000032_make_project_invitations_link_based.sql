-- Migration: simplify project invitations to role-based links.
--
-- Invitations remain token-based and expire automatically, but no longer
-- require binding the link to a specific email address.
