...
import styles from "@/presentation/components/ticket/createTicketForm/CreateTicketForm.module.scss";
import type { Option } from "@/presentation/components/ticket/createTicketForm/CreateTicketForm.types";
import {
  buildEpicOptions,
