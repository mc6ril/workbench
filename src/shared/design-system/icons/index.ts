...
export { default as MealsIcon } from "./meals_icon";
export { default as MoreHorizontalIcon } from "./more_horizontal_icon";
...
export { default as ShoppingCartIcon } from "./shopping_cart_icon";
export { default as TrashIcon } from "./trash_icon";
