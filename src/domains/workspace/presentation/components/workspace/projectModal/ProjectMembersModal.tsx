                ...
                return (
                  ...
                  >
                    <div className={styles["project-members-modal__identity"]}>
                      ...
                      <div
                        className={
                          styles["project-members-modal__identity-copy"]
                        }
                      >
                        <div
                          className={styles["project-members-modal__name-row"]}
                        >
                          <span
                            className={styles["project-members-modal__name"]}
                          >
                            {displayName}
                          </span>
                          <span
                        ...
                        {email && (
                          <div
                            className={styles["project-members-modal__email"]}
                          >
                            {email}
                          </div>
                        )}
                    ...
                    <div className={styles["project-members-modal__controls"]}>
                      <label
                        className={styles["project-members-modal__role-field"]}
                      >
                        <span
                          className={
                            styles["project-members-modal__role-label"]
                          }
                        >
                        ...
                        <select
                          className={
                            styles["project-members-modal__role-select"]
                          }
                          value={member.role}
                          disabled={isBusy}
