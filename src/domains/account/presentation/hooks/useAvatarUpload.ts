...
import { removeAvatar } from "@/domains/account/core/usecases/removeAvatar";
import { uploadAvatar } from "@/domains/account/core/usecases/uploadAvatar";
...
export const useUploadAvatar = () => {
  ...
  return useMutation({
    mutationFn: ({ userId, file }: { userId: string; file: File }) =>
      uploadAvatar(accountGateway, userId, file),
...
export const useRemoveAvatar = () => {
  ...
  return useMutation({
    mutationFn: (userId: string) => removeAvatar(accountGateway, userId),
