...
export const PLAN_CAPABILITIES: Record<SubscriptionPlan, PlanCapabilityMap> = {
  [SubscriptionPlan.FREE]: {
    [PlanFeature.EPICS]: { type: "boolean", access: false },
    ...
    [PlanFeature.MEMBERS_PER_WORKSPACE]: { type: "limit", limit: 3 },
    [PlanFeature.TICKETS]: { type: "limit", limit: 50 },
    [PlanFeature.CUSTOM_COLUMNS]: { type: "limit", limit: 3 },
  },
  [SubscriptionPlan.PRO]: {
    ...
    [PlanFeature.MEMBERS_PER_WORKSPACE]: { type: "limit", limit: 10 },
  ...
  [SubscriptionPlan.TEAM]: {
    ...
    [PlanFeature.MEMBERS_PER_WORKSPACE]: { type: "limit", limit: 25 },
    [PlanFeature.TICKETS]: { type: "limit", limit: UNLIMITED },
    [PlanFeature.CUSTOM_COLUMNS]: { type: "limit", limit: UNLIMITED },
  },
};
